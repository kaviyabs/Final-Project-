        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {[
            ...
            },
            {
              ...
              value: `${stats?.avgCredibilityScore || 0}%`,
              change: "-2.1%",
              trend: "down",
              icon: TrendingUp,
            },
            {
              ...
              value: (stats?.fakeCount || 0).toLocaleString(),
              change: "+15.8%",
              trend: "up",
              icon: AlertTriangle,
            },
          ...
          <Card variant="glass">
            ...
            <CardContent>
              <div className="space-y-4">
                {[
                  { label: "Credible", count: stats?.realCount || 0, percentage: stats?.totalAnalyses ? Math.round((stats.realCount / stats.totalAnalyses) * 100) : 0, color: "bg-success" },
                  { label: "Suspicious", count: stats?.suspiciousCount || 0, percentage: stats?.totalAnalyses ? Math.round((stats.suspiciousCount / stats.totalAnalyses) * 100) : 0, color: "bg-suspicious" },
                  { label: "Unreliable", count: stats?.fakeCount || 0, percentage: stats?.totalAnalyses ? Math.round((stats.fakeCount / stats.totalAnalyses) * 100) : 0, color: "bg-destructive" },
                ].map((item, i) => (
                  <div key={i}>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">{new Date(analysis.date).toLocaleTimeString()}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
