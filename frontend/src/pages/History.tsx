      ...
      <div className="container px-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="ghost" size="sm" className="gap-2 text-destructive" onClick={clearHistory}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {[
            { label: "Total Analyses", value: history.length, icon: HistoryIcon },
            { label: "Credible", value: history.filter((h) => h.verdict === "REAL").length, icon: CheckCircle },
            { label: "Suspicious", value: history.filter((h) => h.verdict === "SUSPICIOUS").length, icon: AlertTriangle },
            { label: "Unreliable", value: history.filter((h) => h.verdict === "FAKE").length, icon: XCircle },
          ].map((stat, i) => (
